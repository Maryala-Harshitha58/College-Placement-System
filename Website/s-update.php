<?php include("connection.php");
 $cn= $_GET['cn'];
 $query = "SELECT * FROM reg  where email='$cn' ";
...
<div class="input-field">
<input type="text" value="<?php echo $result['year']; ?>"
...
if(isset($_POST['register'])) {
 ...
 $query = "update reg set fullName='$fname',year='$year',email='$email',password='$password',pnumber='$pnumber',qualification='$qualification' WHERE email='$cn' ";
     $data = mysqli_query($conn,$query);
     if($data)
     {
                       ?> 
